...
6.6% of orders were delivered late, with a maximum delay of 188 days.
Early deliveries raise customer expectations — when the same customer
gets a late delivery later, frustration is higher and leads to 1 star
ratings. Late deliveries average 2.27 stars vs 4.29 for on-time orders.

**Revenue Concentration**
São Paulo generates 38% of total revenue. The top 3 states — SP, RJ, MG
— account for 63% of all revenue. The marketing strategies working in SP
should be rolled out to other states in batches.

**Cancellations and Stock Risk**
625 cancellations may be linked to 609 unavailable orders, suggesting
sellers are accepting orders without confirming stock availability.
Recommendation: real-time inventory checks before order confirmation.
